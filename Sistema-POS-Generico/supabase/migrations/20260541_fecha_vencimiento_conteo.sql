ALTER TABLE public.inventory_counts ADD COLUMN IF NOT EXISTS fecha_vencimiento date;
...
BEGIN
    ...
    LOOP
        ...
        IF v_row.diferencia > 0 THEN
            SELECT MAX(ic.fecha_vencimiento) INTO v_fecha_venc
            FROM public.inventory_counts ic
            WHERE ic.session_id = p_session_id
              AND ic.maestro_producto_id = v_row.maestro_producto_id
              AND ic.fecha_vencimiento IS NOT NULL;
            ...
            INSERT INTO public.productos (
                ...
                'AJUSTE-' || TO_CHAR(NOW(), 'YYYYMMDD'), 'Bueno', NOW(), v_fecha_venc
