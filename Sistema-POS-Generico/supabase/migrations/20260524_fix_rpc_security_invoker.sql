-- Diagnostic fix: completamente recrear la funcion sin dependencias del SECURITY DEFINER anterior
...
GRANT EXECUTE ON FUNCTION public.analizar_diferencias_inventario(uuid) TO authenticated, anon, service_role;

-- Tambien arreglar aplicar_ajuste_inventario por si acaso
...
GRANT EXECUTE ON FUNCTION public.aplicar_ajuste_inventario(uuid, uuid) TO authenticated, anon, service_role;
